...
#include "../../mailing/mimemultipart.h"
...
struct qt_meta_stringdata_MimeMultiPart_t {
    QByteArrayData data[1];
    char stringdata0[14];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_MimeMultiPart_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MimeMultiPart_t qt_meta_stringdata_MimeMultiPart = {
    {
QT_MOC_LITERAL(0, 0, 13) // "MimeMultiPart"
...
const QMetaObject MimeMultiPart::staticMetaObject = {
    { &MimePart::staticMetaObject, qt_meta_stringdata_MimeMultiPart.data,
      qt_meta_data_MimeMultiPart,  qt_static_metacall, nullptr, nullptr}
};
...
void *MimeMultiPart::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MimeMultiPart.stringdata0))
